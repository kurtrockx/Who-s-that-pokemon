    ...
    <div className="mx-auto flex h-full items-center gap-2 duration-500 starting:scale-20">
      <div className="group relative h-full origin-right overflow-hidden delay-500 duration-200 starting:scale-x-0">
        <img
          ...
          onClick={handleCry}
        />
        <p className="pointer-events-none absolute bottom-4 left-0 origin-left rounded-xl border-2 bg-black px-2 py-px text-xs text-white delay-100 duration-200 ease-in-out group-hover:translate-0 max-sm:text-[.5rem] max-sm:opacity-70 sm:-translate-x-100">
          click for cry
        </p>
      </div>
